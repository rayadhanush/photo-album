...
const API_KEY = "e6esVfyXMRaUQH5emukZG8otNCN3QiFnv5QEK42d";
...
function uploadPhoto() {
  ...
  reader.onload = function (event) {
    ...
    fetch(
      `https://wf884ytiqh.execute-api.us-east-1.amazonaws.com/test1/upload/dr3631-b2/${encodeURIComponent(
        name_f
      )}`,
      requestOptions
    )
