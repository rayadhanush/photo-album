...
apigClientFactory.newClient = function (config) {
  ...
  var invokeUrl =
    "https://16577esc56.execute-api.us-east-1.amazonaws.com/alpha";
  ...
  apigClient.uploadBucketOptions = function (params, body, additionalParams) {
    ...
    var uploadBucketOptionsRequest = {
      ...
      path:
        pathComponent +
        uritemplate("/upload/{bucket}").expand(
          apiGateway.core.utils.parseParametersToObject(params, [])
        ),
      headers: apiGateway.core.utils.parseParametersToObject(params, []),
      queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
  ...
  apigClient.uploadBucketKeyPut = function (params, body, additionalParams) {
    ...
    apiGateway.core.utils.assertParametersDefined(
      params,
      ["key", "bucket", "x-amz-meta-customlabels"],
      ["body"]
    );
    ...
    var uploadBucketKeyPutRequest = {
      ...
      path:
        pathComponent +
        uritemplate("/upload/{bucket}/{key}").expand(
          apiGateway.core.utils.parseParametersToObject(params, [
            "key",
            "bucket",
          ])
  ...
  apigClient.uploadBucketKeyOptions = function (
    params,
    body,
    additionalParams
  ) {
